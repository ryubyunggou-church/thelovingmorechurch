...
| `ae815ca` | 2026-08-21 | fix(lint): 남은 경고 3건 정리 — useEffect 의존성 누락 + 죽은 re-export |
| `9491cbf` | 2026-08-21 | fix(test): jsdom ResizeObserver 폴리필 추가 — App.test.tsx 크래시 수정 |
| `2320844` | 2026-08-21 | feat(about): 사역자 카드 호버 리디자인 — 세피아→컬러 전환 + 골드 헤어라인 프레임 |
| `1f80ccc` | 2026-08-21 | feat(admin): 인라인 편집 진입점에 호버 오버레이 강조 추가 |
| `1477278` | 2026-08-20 | docs: PRD 문서를 교육부서 3탭 구조로 갱신 |
| `8111ce6` | 2026-08-20 | fix(hero): 관리자 '관리로 이동' 버튼이 투명 헤더에 가려 클릭 안 되는 문제 수정 |
| `aac2ef4` | 2026-08-20 | content(seed): placeholder 콘텐츠를 실데이터로 교체 + 교육부서 Firestore 동기화 |
| `b74dbaf` | 2026-08-20 | feat(education): 유치부 삭제 가능 처리 후 완전 제거 — 3부서 고정 구조로 정리 |
